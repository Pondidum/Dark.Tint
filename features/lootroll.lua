...
local function CreateRollButton(parent, ntex, ptex, htex, rolltype, tiptext, ...)
	...
	txt:SetFont(fonts.unitframes, 12, "OUTLINE")
...
local function CreateRollFrame()
	...
	status:SetStatusBarTexture(textures.normal)
	...
	bind:SetFont(fonts.unitframes, 12, "OUTLINE")
	frame.fsbind = bind

	local loot = frame:CreateFontString(nil, "ARTWORK")
	loot:SetFont(fonts.unitframes, 12, "OUTLINE")
...
label:SetFont(fonts.unitframes, 12, "OUTLINE")
label:SetAllPoints(anchor)
label:SetText("Move Loot Roll Frame")
...
local lootRoll = function(frame, event)
	...
	anchor:SetPoint("CENTER", UIParent, "CENTER", 0, -400)

end

ns.features.lootRoll = lootRoll
